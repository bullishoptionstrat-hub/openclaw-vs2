"""
fib7 robustness: OOS splits, friction, and parameter grids.

Extends fib6 robustness with fib7's multi-bar regime config support.
"""
...
# ---------------------------------------------------------------------------
# Parameter neighborhood grids (from fib7 experiments)
# ---------------------------------------------------------------------------
            ...
            grid_results.append(
                {
                    ...
                    "regime_bar": getattr(cfg, "regime_bar", "discovery"),
                }
            )
            continue
